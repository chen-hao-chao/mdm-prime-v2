...
def make_isoflop_data():
    ...
    # Raw Data
    budget_parameters = {
        "3e18": np.array([14e6, 25e6, 36e6, 49e6, 64e6, 79e6, 106e6, 154e6, 201e6, 252e6], dtype=float), # (201)
        "6e18": np.array([25e6, 36e6, 49e6, 64e6, 79e6, 106e6, 154e6, 201e6, 252e6, 354e6, 413e6], dtype=float), # (201)
        "1e19": np.array([36e6, 64e6, 79e6, 106e6, 154e6, 201e6, 252e6, 354e6, 413e6, 571e6], dtype=float), # (201)
        "3e19": np.array([79e6, 106e6, 154e6, 201e6, 252e6, 354e6, 413e6, 571e6, 771e6, 1107e6], dtype=float), # (201)
        "6e19": np.array([106e6, 201e6, 252e6, 354e6, 413e6, 571e6, 771e6, 1107e6, 1529e6], dtype=float), 
        "1e20": np.array([201e6, 252e6, 354e6, 413e6, 571e6, 771e6, 1107e6, 1529e6, 2359e6], dtype=float), # (413)
        "3e20": np.array([252e6, 354e6, 413e6, 571e6, 771e6, 1107e6, 1529e6, 2359e6, 3416e6], dtype=float) # (413)
    }
    budget_parameters_loss = {
        "3e18": np.array([4.144, 4.009, 3.993, 3.971, 3.964, 3.961, 3.997, 4.060, 4.120, 4.197], dtype=float),
        "6e18": np.array([3.899, 3.846, 3.829, 3.780, 3.789, 3.805, 3.838, 3.889, 3.907, 4.026, 4.064], dtype=float),
        "1e19": np.array([3.770, 3.697, 3.691, 3.677, 3.686, 3.719, 3.766, 3.842, 3.891, 3.939], dtype=float),
        "3e19": np.array([3.514, 3.481, 3.478, 3.451, 3.468, 3.488, 3.498, 3.588, 3.664, 3.758], dtype=float), 
        "6e19": np.array([3.424, 3.408, 3.382, 3.398, 3.405, 3.443, 3.480, 3.536, 3.656], dtype=float), 
        "1e20": np.array([3.335, 3.299, 3.297, 3.289, 3.294, 3.327, 3.351, 3.409, 3.473], dtype=float),
        "3e20": np.array([3.144, 3.110, 3.095, 3.085, 3.081, 3.098, 3.106, 3.150, 3.212], dtype=float) #252e6, 354e6
    }
...
ax.set_title("MDM", fontsize=24, fontweight='bold')
...
output_file = 'animation_iso_mdm.gif'
